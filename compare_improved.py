...
print("Improved RandomForest - R²:", round(rf_r2, 4), "MAE:", round(rf_mae, 4), "RMSE:", round(rf_rmse, 4))

# XGBoost
xgb_model = xgb.XGBRegressor(objective='reg:squarederror', random_state=42)
param_grid_xgb = {'n_estimators': [200, 300], 'max_depth': [3, 6], 'learning_rate': [0.1, 0.2]}
grid_xgb = GridSearchCV(xgb_model, param_grid_xgb, cv=5, scoring='r2')
...
print("Best improved model saved as best_improved_model.pkl")
